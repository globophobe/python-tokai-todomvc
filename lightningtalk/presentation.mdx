...
As for 404, clients such as Apollo will return null on HTTP 404.

---

# Ariadne does not appear to define a 404 error.

---

# However, it is easy to subclass ariadne's HttpError.
